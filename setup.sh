...
if [[ "$OSTYPE" == "darwin"* ]]; then
  ...
  echo "                   coreutils direnv exa fd fzf gh ghc git-delta \\"
  echo "                   glances go htop jq lnav multitail neovim \\"
  echo "                   prettyping python3 rbenv ripgrep rustup-init \\"
  echo "                   shellcheck swaks tldr tig wget universal-ctags\`"
