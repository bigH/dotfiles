...
if [[ "$OSTYPE" == "darwin"* ]]; then
  ...
  echo "     \`brew install ack autojump bat broot cabal cloc coreutils exa fd \\"
  echo "                   fzf ghc glances go htop neovim python3 rbenv ripgrep \\"
  echo "                   rustup-init swaks tig wget universal-ctags\`"
