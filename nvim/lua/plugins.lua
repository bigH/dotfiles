...
hooks.register(hooks.type.HIGHLIGHT_SETUP, function()
    vim.api.nvim_set_hl(0, "RainbowIndentRed",
        { fg = configs.blendToBackground(configs.colors.red), bg = configs.dark_bg_indent })
    vim.api.nvim_set_hl(0, "RainbowIndentYellow",
        { fg = configs.blendToBackground(configs.colors.yellow), bg = configs.light_bg_indent })
    vim.api.nvim_set_hl(0, "RainbowIndentBlue",
        { fg = configs.blendToBackground(configs.colors.blue), bg = configs.dark_bg_indent })
    vim.api.nvim_set_hl(0, "RainbowIndentOrange",
        { fg = configs.blendToBackground(configs.colors.orange), bg = configs.light_bg_indent })
    vim.api.nvim_set_hl(0, "RainbowIndentGreen",
        { fg = configs.blendToBackground(configs.colors.green), bg = configs.dark_bg_indent })
    vim.api.nvim_set_hl(0, "RainbowIndentViolet",
        { fg = configs.blendToBackground(configs.colors.violet), bg = configs.light_bg_indent })
end)
