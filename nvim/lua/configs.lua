...
M.special_windows = {
    'qf', 'vista_kind', 'terminal', 'packer', 'dap-repl', 'dapui_stacks',
    'dapui_watches', 'dapui_breakpoints', 'dapui_console', 'dapui_scopes',
    'dapui_repl', 'dapui_controls', 'dapui_state'
}
...
M.light_bg_indent = M.utils
                        .blendColors(M.colors.bg, M.colors.bg_highlight, 0.65)
