...
require('packer').startup(function(use)
    ...
    -- color-scheme
    use {
        'folke/tokyonight.nvim', disable = isVSCode,
    }

    -- file navigation tree
    use {
        'kyazdani42/nvim-tree.lua',
        requires = 'kyazdani42/nvim-web-devicons', disable = isVSCode,
    }
    ...
    use {
        ...
        tag = '*', disable = isVSCode,
    }

    -- `gc`/`gb` to comment
    use {
        'numToStr/Comment.nvim', disable = isVSCode,
    }
    ...
    -- rainbow delimiters
    use {
        'HiPhish/rainbow-delimiters.nvim', disable = isVSCode,
    }

    -- indent guides
    use {
        'lukas-reineke/indent-blankline.nvim', disable = isVSCode,
    }
    ...
    use {
        'Wansmer/treesj',
        requires = { 'nvim-treesitter/nvim-treesitter' }, disable = isVSCode,
    }
    ...
    use {
        'neovim/nvim-lspconfig', disable = isVSCode,
    }
    use {
        'folke/neodev.nvim', disable = isVSCode,
    }

    use {
        'hrsh7th/nvim-cmp', disable = isVSCode,
    }

    use {
        'hrsh7th/cmp-nvim-lsp', disable = isVSCode,
    }
    use {
        'hrsh7th/cmp-path', disable = isVSCode,
    }
    use {
        'ray-x/cmp-treesitter', disable = isVSCode,
    }
    use {
        'hrsh7th/cmp-buffer', disable = isVSCode,
    }
    use {
        'hrsh7th/cmp-cmdline', disable = isVSCode,
    }
    use {
        'hrsh7th/cmp-emoji', disable = isVSCode,
    }
    use {
        'dmitmel/cmp-cmdline-history', disable = isVSCode,
    }

    use {
        'onsails/lspkind.nvim', disable = isVSCode,
    }
    ...
    use {
        'mfussenegger/nvim-dap', disable = isVSCode,
    }
    ...
    use {
        'leoluz/nvim-dap-go',
        requires = 'mfussenegger/nvim-dap', disable = isVSCode,
    }
    ...
    use {
        'github/copilot.vim', disable = isVSCode,
    }
    use {
